...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#f1f5f8] text-[#17222d]">
    ...
    <section className="mx-auto grid max-w-[1440px] gap-6 px-4 py-6 lg:grid-cols-[minmax(340px,430px)_minmax(0,1fr)] lg:px-8">
      ...
      <section className="flex min-h-[620px] flex-col rounded-2xl border border-[#dce5eb] bg-[#e5ecf1] p-4 sm:p-7 lg:sticky lg:top-4 lg:h-[calc(100vh-7rem)] lg:min-h-0 lg:self-start"><div className="mb-4 flex items-center justify-between"><div><h2 className="font-bold">Print preview</h2><p className="text-xs text-[#647585]">Based on your supplied Photoshop artwork</p></div><span className="rounded-full bg-white px-3 py-1 text-xs font-semibold text-[#1668ad] shadow-sm">Front side</span></div><div className="grid min-h-0 flex-1 place-items-center overflow-hidden rounded-xl bg-[radial-gradient(circle_at_center,#f8fafb_0,#dbe4ea_100%)] p-4 sm:p-7"><canvas ref={canvasRef} width={2050} height={3310} aria-label="Employee ID card preview" className="h-auto max-h-full w-auto max-w-full rounded-[10px] bg-white shadow-[0_24px_70px_rgba(29,52,69,.24)]" /></div></section>
    </section>
  </main>;
}
